...
String webTail="<p><a href='/wifi'>네트웍공유기변경-누른후 와이파설정부터 다시하세요</a></p> &emsp;&emsp;<a href='scan'> <button >기기찿기</button></a> </body> </html>";
...
void makeHtml() {
  ...
  //s=s+"&emsp;&emsp;<a href='scan'> <button >기기찿기</button></a>";
  webHtml=s;
}
void makeMenu() {
  int no;
