...
void handleRoot() {
  ...
  s+="<form action='/on'>";
  if(p4[4]==1) 
    s=s+"<button type='submit' name='button' value='4' class='button button-on' >모니터링</button></a>"; //off
  else 
    s=s+"<button type='submit' name='button' value='4' class='button button-off' >모니터링</button></a>"; //on
  s+="</form>";
